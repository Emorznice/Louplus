...
# print(letter_codes)->[87, 65, 83, 68, 82, 81, 119, 97, 115, 100, 114, 113]
# 将输入与行为进行关联
actions_dict = dict(zip(letter_codes, actions * 2))
# print(actions_dict)->{87: 'Up', 65: 'Left', 83: 'Down', 68: 'Right', 82: 'Restart', 81: 'Exit', 119: 'Up', 97: 'Left', 115: 'Down', 100: 'Right', 114: 'Restart', 113: 'Exit'}
...
class GameField(object):
    ...
    def spawn(self):  # spawn：引发
        # 从100中取一个随机数，如果这个随机数大于89，new_element 等于4，否则等于2
...
# curses.wrapper 函数会激活并初始化终端进入‘curses’模式
curses.wrapper(main)
